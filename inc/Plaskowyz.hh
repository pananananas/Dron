...
#define PLIK_PLASKOWYZA         "bryly/szescian_na_powierzchni.dat"
using std :: string;

/*!
 * \brief Modeluje pojęcie Płaskowyża
 *
 *  Klasa modeluje pojęcie Płaskowyża.
*/
class Plaskowyz: public BrylaGeometryczna{
private:
        /*!
    * \brief Ilość elementów typu płaskowyż
    *
...
*/
    Wektor<3> WyswietlPolozenie() const { return Polozenie;               };    /*!
                                                               ...
                                                               *
*/
    string    WyswietlRodzaj()    const { string N="Płaskowyż"; return N; };    /*!
...
*/
    string    TworzNazwePlikuPlaskowyza(int I);                                 /*!
...
*/
    void      UstawIloscObiektow(int i)   { IloscPlaskowyzow = i; };            /*!
...
*/
    vector<Wektor<3>>   ObrysBryly();                                           /*!
                                                                                 * \brief Desktuktor Plaskowyzu
                                                                                 *
                                                                                 * Definiuje destruktor plaskowyzu
                                                                                 *
*/
    ~Plaskowyz() {};
};
